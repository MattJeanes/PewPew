 ...
 function EFFECT:Init( data ) 
	...
	self.emitter = ParticleEmitter( self.vOffset )
		...
		for i=0, (50) do
			...
			if (particle) then
				particle:SetVelocity( Pos * math.Rand(700, 1300) )
				particle:SetLifeTime( 0 )
				particle:SetDieTime( math.Rand( 9, 12 ) )
				particle:SetStartAlpha( math.Rand( 200, 255 ) )
				particle:SetEndAlpha( 0 )
				particle:SetStartSize( 850 )
			...
			if (particle1) then
				...
				particle1:SetDieTime( 6.3 )
				particle1:SetStartAlpha( math.Rand( 200, 255 ) )
				particle1:SetEndAlpha( 0 )
				particle1:SetStartSize( 1000 )
				particle1:SetEndSize( 90 )
