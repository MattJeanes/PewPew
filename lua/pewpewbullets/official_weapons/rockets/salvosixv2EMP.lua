...
-- General Information
BULLET.Name = "[Homing] Salvo Six (EMP)"
BULLET.Author = "Hexwolf (Base by Divran)"
BULLET.Description = "Rapidly fires a spectacle of up to six light explosive partial tracking missiles. Equipped with an EMP warhead."
