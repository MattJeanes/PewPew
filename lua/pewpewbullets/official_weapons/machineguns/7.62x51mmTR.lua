...
-- General Information
BULLET.Name = "7.62×51mm Minigun (Tracer)"
BULLET.Author = "Hexwolf (Base by Divran)"
BULLET.Description = "Short spool time, followed by a hail of bullets marked by bright red tracer rounds.."
BULLET.AdminOnly = false
BULLET.SuperAdminOnly = false

-- Appearance
BULLET.Model = "models/combatmodels/tankshell_25mm.mdl"
BULLET.Color = Color(255,0,0)
BULLET.Trail = {StartSize=20, EndSize=0, Length=0.1, Texture="trails/smoke.vmt", Color=Color(255,0,0)}
